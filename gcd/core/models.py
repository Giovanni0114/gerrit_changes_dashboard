...
class AppContext(Protocol):
    ...
    def open_change_webui(self, row: Index, new_window: bool = False) -> None: ...
    def activate(self, row: Index) -> None: ...
...
PluginEvent = Literal["new_comment", "new_approval", "status_changed", "new_change", "activate"]
